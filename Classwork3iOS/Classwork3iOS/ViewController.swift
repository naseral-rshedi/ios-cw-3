...
class ViewController: UIViewController {
    ...
    var  helloLangauge = ["اهلا"," Hola "," Bonjour "," Konnichiwa "," Namaste " , "Merhaba", "Hi"]
    var flagLanguage = [" 🇰🇼 "," 🇪🇸  "," 🇫🇷  "," 🇯🇵 "," 🇮🇳 ", "🇹🇷","🇺🇸"]
    ...
    @IBAction func Pressbutton(_ sender: Any) {
        ...
        addName(name: "Naser", helloArayy: helloLangauge, flagArray: flagLanguage)
    ...
    func addName(name: String ,helloArayy: [String], flagArray: [String]){
        for i in 0..<helloArayy.count{
        greetingArray[i] = "\(helloArayy[i]) \(name) \(flagArray[i])"
        }
